...
class ComposantFlute:
	
	def __gerer(self, widget, data):
		tracer("ComposantFlute", "__gerer")
	...
	def __init__(self, notes):
		tracer("ComposantFlute", "__init__")
		self.liste = ListeFlutes()
		self.noms = self.liste.getListeNoms()
		instrument = self.liste.getInstrument(self.noms[0])
		self.canvas = canvas_flute.CanvasFlute(instrument)
		lisPRE = ['0','1']
		lisNBR = ['1','2']
